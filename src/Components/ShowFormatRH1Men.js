...
import ContainerTableRH1Men from "./ContainerTableRH1Men";

const ShowFormatRH1Men = () => {
    const [visibleTable, setVisibleTable] = useState('none')
    const {register, formState: {errors}, handleSubmit,control } = useForm()
    const onSubmit = (data) => {
        alert("Desde Rh1\nNos llega por ahora: "+data.initDate+" "+data.endDate)
...
export default ShowFormatRH1Men